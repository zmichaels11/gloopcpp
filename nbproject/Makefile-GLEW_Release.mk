...
${OBJECTDIR}/cglgfx/graphics.o: cglgfx/graphics.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cglgfx/graphics.o cglgfx/graphics.cpp

${OBJECTDIR}/glgfx/blend_mode.o: glgfx/blend_mode.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/blend_mode.o glgfx/blend_mode.cpp

${OBJECTDIR}/glgfx/graphics.o: glgfx/graphics.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/graphics.o glgfx/graphics.cpp

${OBJECTDIR}/glgfx/renderers/line_renderer.o: glgfx/renderers/line_renderer.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx/renderers
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/renderers/line_renderer.o glgfx/renderers/line_renderer.cpp

${OBJECTDIR}/glgfx/renderers/masked_image_renderer.o: glgfx/renderers/masked_image_renderer.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx/renderers
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/renderers/masked_image_renderer.o glgfx/renderers/masked_image_renderer.cpp

${OBJECTDIR}/glgfx/renderers/solid_renderer.o: glgfx/renderers/solid_renderer.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx/renderers
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/renderers/solid_renderer.o glgfx/renderers/solid_renderer.cpp

${OBJECTDIR}/glgfx/renderers/sprite_renderer.o: glgfx/renderers/sprite_renderer.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx/renderers
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/renderers/sprite_renderer.o glgfx/renderers/sprite_renderer.cpp

${OBJECTDIR}/glgfx/skyline_packer.o: glgfx/skyline_packer.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/skyline_packer.o glgfx/skyline_packer.cpp
...
${OBJECTDIR}/glgfx/sprite_buffers/vbo_sprite_buffer.o: glgfx/sprite_buffers/vbo_sprite_buffer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/sprite_buffers/vbo_sprite_buffer.o glgfx/sprite_buffers/vbo_sprite_buffer.cpp

${OBJECTDIR}/glgfx/sprite_sheet.o: glgfx/sprite_sheet.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/sprite_sheet.o glgfx/sprite_sheet.cpp
...
${OBJECTDIR}/gloop/matrices.o: gloop/matrices.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/matrices.o gloop/matrices.cpp

${OBJECTDIR}/gloop/pixel_formats.o: gloop/pixel_formats.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/pixel_formats.o gloop/pixel_formats.cpp
...
${OBJECTDIR}/gloop/wrapper/gles3_buffer_objects.o: gloop/wrapper/gles3_buffer_objects.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles3_buffer_objects.o gloop/wrapper/gles3_buffer_objects.cpp

${OBJECTDIR}/gloop/wrapper/gles3_drawing_commands.o: gloop/wrapper/gles3_drawing_commands.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles3_drawing_commands.o gloop/wrapper/gles3_drawing_commands.cpp

${OBJECTDIR}/gloop/wrapper/gles3_framebuffer_objects.o: gloop/wrapper/gles3_framebuffer_objects.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles3_framebuffer_objects.o gloop/wrapper/gles3_framebuffer_objects.cpp

${OBJECTDIR}/gloop/wrapper/gles3_gl.o: gloop/wrapper/gles3_gl.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles3_gl.o gloop/wrapper/gles3_gl.cpp

${OBJECTDIR}/gloop/wrapper/gles3_shaders_and_programs.o: gloop/wrapper/gles3_shaders_and_programs.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles3_shaders_and_programs.o gloop/wrapper/gles3_shaders_and_programs.cpp

${OBJECTDIR}/gloop/wrapper/gles3_states.o: gloop/wrapper/gles3_states.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles3_states.o gloop/wrapper/gles3_states.cpp

${OBJECTDIR}/gloop/wrapper/gles3_texture_objects.o: gloop/wrapper/gles3_texture_objects.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles3_texture_objects.o gloop/wrapper/gles3_texture_objects.cpp

${OBJECTDIR}/gloop/wrapper/gles3_vertex_arrays.o: gloop/wrapper/gles3_vertex_arrays.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles3_vertex_arrays.o gloop/wrapper/gles3_vertex_arrays.cpp
...
${OBJECTDIR}/gloop/wrapper/glew_framebuffer_objects.o: gloop/wrapper/glew_framebuffer_objects.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/glew_framebuffer_objects.o gloop/wrapper/glew_framebuffer_objects.cpp
...
${OBJECTDIR}/lesson06.o: lesson06.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lesson06.o lesson06.cpp
...
${OBJECTDIR}/sprite_test.o: sprite_test.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sprite_test.o sprite_test.cpp
