...
${OBJECTDIR}/gloop/application_nomain.o: ${OBJECTDIR}/gloop/application.o gloop/application.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/application_nomain.o gloop/application.cpp;\
	else  \
...
${OBJECTDIR}/gloop/bitfields/buffer_access_hint_nomain.o: ${OBJECTDIR}/gloop/bitfields/buffer_access_hint.o gloop/bitfields/buffer_access_hint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/bitfields/buffer_access_hint_nomain.o gloop/bitfields/buffer_access_hint.cpp;\
	else  \
...
${OBJECTDIR}/gloop/bitfields/buffer_immutable_storage_hint_nomain.o: ${OBJECTDIR}/gloop/bitfields/buffer_immutable_storage_hint.o gloop/bitfields/buffer_immutable_storage_hint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/bitfields/buffer_immutable_storage_hint_nomain.o gloop/bitfields/buffer_immutable_storage_hint.cpp;\
	else  \
...
${OBJECTDIR}/gloop/bitfields/clear_mask_nomain.o: ${OBJECTDIR}/gloop/bitfields/clear_mask.o gloop/bitfields/clear_mask.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/bitfields/clear_mask_nomain.o gloop/bitfields/clear_mask.cpp;\
	else  \
...
${OBJECTDIR}/gloop/buffer_nomain.o: ${OBJECTDIR}/gloop/buffer.o gloop/buffer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/buffer_nomain.o gloop/buffer.cpp;\
	else  \
...
${OBJECTDIR}/gloop/draw_calls_nomain.o: ${OBJECTDIR}/gloop/draw_calls.o gloop/draw_calls.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/draw_calls_nomain.o gloop/draw_calls.cpp;\
	else  \
...
${OBJECTDIR}/gloop/error/base_error_nomain.o: ${OBJECTDIR}/gloop/error/base_error.o gloop/error/base_error.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/error/base_error_nomain.o gloop/error/base_error.cpp;\
	else  \
...
${OBJECTDIR}/gloop/exception/base_exception_nomain.o: ${OBJECTDIR}/gloop/exception/base_exception.o gloop/exception/base_exception.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/exception/base_exception_nomain.o gloop/exception/base_exception.cpp;\
	else  \
...
${OBJECTDIR}/gloop/program_nomain.o: ${OBJECTDIR}/gloop/program.o gloop/program.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/program_nomain.o gloop/program.cpp;\
	else  \
...
${OBJECTDIR}/gloop/program_uniform_binding_nomain.o: ${OBJECTDIR}/gloop/program_uniform_binding.o gloop/program_uniform_binding.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/program_uniform_binding_nomain.o gloop/program_uniform_binding.cpp;\
	else  \
...
${OBJECTDIR}/gloop/shader_nomain.o: ${OBJECTDIR}/gloop/shader.o gloop/shader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/shader_nomain.o gloop/shader.cpp;\
	else  \
...
${OBJECTDIR}/gloop/states/blend_nomain.o: ${OBJECTDIR}/gloop/states/blend.o gloop/states/blend.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/states/blend_nomain.o gloop/states/blend.cpp;\
	else  \
...
${OBJECTDIR}/gloop/states/clear_nomain.o: ${OBJECTDIR}/gloop/states/clear.o gloop/states/clear.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/states/clear_nomain.o gloop/states/clear.cpp;\
	else  \
...
${OBJECTDIR}/gloop/states/depth_range_nomain.o: ${OBJECTDIR}/gloop/states/depth_range.o gloop/states/depth_range.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/states/depth_range_nomain.o gloop/states/depth_range.cpp;\
	else  \
...
${OBJECTDIR}/gloop/states/scissor_nomain.o: ${OBJECTDIR}/gloop/states/scissor.o gloop/states/scissor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/states/scissor_nomain.o gloop/states/scissor.cpp;\
	else  \
...
${OBJECTDIR}/gloop/tools_nomain.o: ${OBJECTDIR}/gloop/tools.o gloop/tools.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/tools_nomain.o gloop/tools.cpp;\
	else  \
...
${OBJECTDIR}/gloop/uniform/uniform_bindings_nomain.o: ${OBJECTDIR}/gloop/uniform/uniform_bindings.o gloop/uniform/uniform_bindings.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/uniform/uniform_bindings_nomain.o gloop/uniform/uniform_bindings.cpp;\
	else  \
...
${OBJECTDIR}/gloop/uniform/uniform_block_binding_nomain.o: ${OBJECTDIR}/gloop/uniform/uniform_block_binding.o gloop/uniform/uniform_block_binding.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/uniform/uniform_block_binding_nomain.o gloop/uniform/uniform_block_binding.cpp;\
	else  \
...
${OBJECTDIR}/gloop/vertex_array_nomain.o: ${OBJECTDIR}/gloop/vertex_array.o gloop/vertex_array.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/vertex_array_nomain.o gloop/vertex_array.cpp;\
	else  \
...
${OBJECTDIR}/gloop/vertex_attribute_binding_nomain.o: ${OBJECTDIR}/gloop/vertex_attribute_binding.o gloop/vertex_attribute_binding.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/vertex_attribute_binding_nomain.o gloop/vertex_attribute_binding.cpp;\
	else  \
...
${OBJECTDIR}/gloop/vertex_attributes_nomain.o: ${OBJECTDIR}/gloop/vertex_attributes.o gloop/vertex_attributes.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/vertex_attributes_nomain.o gloop/vertex_attributes.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/gles2_buffer_objects_nomain.o: ${OBJECTDIR}/gloop/wrapper/gles2_buffer_objects.o gloop/wrapper/gles2_buffer_objects.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles2_buffer_objects_nomain.o gloop/wrapper/gles2_buffer_objects.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/gles2_drawing_commands_nomain.o: ${OBJECTDIR}/gloop/wrapper/gles2_drawing_commands.o gloop/wrapper/gles2_drawing_commands.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles2_drawing_commands_nomain.o gloop/wrapper/gles2_drawing_commands.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/gles2_gl_nomain.o: ${OBJECTDIR}/gloop/wrapper/gles2_gl.o gloop/wrapper/gles2_gl.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles2_gl_nomain.o gloop/wrapper/gles2_gl.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/glew_buffer_objects_nomain.o: ${OBJECTDIR}/gloop/wrapper/glew_buffer_objects.o gloop/wrapper/glew_buffer_objects.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/glew_buffer_objects_nomain.o gloop/wrapper/glew_buffer_objects.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/glew_drawing_commands_nomain.o: ${OBJECTDIR}/gloop/wrapper/glew_drawing_commands.o gloop/wrapper/glew_drawing_commands.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/glew_drawing_commands_nomain.o gloop/wrapper/glew_drawing_commands.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/glew_gl_nomain.o: ${OBJECTDIR}/gloop/wrapper/glew_gl.o gloop/wrapper/glew_gl.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/glew_gl_nomain.o gloop/wrapper/glew_gl.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/glew_shaders_and_programs_nomain.o: ${OBJECTDIR}/gloop/wrapper/glew_shaders_and_programs.o gloop/wrapper/glew_shaders_and_programs.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/glew_shaders_and_programs_nomain.o gloop/wrapper/glew_shaders_and_programs.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/glew_vertex_arrays_nomain.o: ${OBJECTDIR}/gloop/wrapper/glew_vertex_arrays.o gloop/wrapper/glew_vertex_arrays.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/glew_vertex_arrays_nomain.o gloop/wrapper/glew_vertex_arrays.cpp;\
	else  \
