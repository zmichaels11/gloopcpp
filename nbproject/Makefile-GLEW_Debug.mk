...
${OBJECTDIR}/dummy_main.o: dummy_main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dummy_main.o dummy_main.cpp
...
${OBJECTDIR}/dummy_main_nomain.o: ${OBJECTDIR}/dummy_main.o dummy_main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dummy_main_nomain.o dummy_main.cpp;\
	else  \
...
${OBJECTDIR}/gloop/states/texture2D_parameters_nomain.o: ${OBJECTDIR}/gloop/states/texture2D_parameters.o gloop/states/texture2D_parameters.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/states/texture2D_parameters_nomain.o gloop/states/texture2D_parameters.cpp;\
	else  \
...
${OBJECTDIR}/gloop/texture2D_nomain.o: ${OBJECTDIR}/gloop/texture2D.o gloop/texture2D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/texture2D_nomain.o gloop/texture2D.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/gles2_shaders_and_programs_nomain.o: ${OBJECTDIR}/gloop/wrapper/gles2_shaders_and_programs.o gloop/wrapper/gles2_shaders_and_programs.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles2_shaders_and_programs_nomain.o gloop/wrapper/gles2_shaders_and_programs.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/gles2_states_nomain.o: ${OBJECTDIR}/gloop/wrapper/gles2_states.o gloop/wrapper/gles2_states.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles2_states_nomain.o gloop/wrapper/gles2_states.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/gles2_texture_objects_nomain.o: ${OBJECTDIR}/gloop/wrapper/gles2_texture_objects.o gloop/wrapper/gles2_texture_objects.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles2_texture_objects_nomain.o gloop/wrapper/gles2_texture_objects.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/gles2_vertex_arrays_nomain.o: ${OBJECTDIR}/gloop/wrapper/gles2_vertex_arrays.o gloop/wrapper/gles2_vertex_arrays.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/gles2_vertex_arrays_nomain.o gloop/wrapper/gles2_vertex_arrays.cpp;\
	else  \
...
${OBJECTDIR}/gloop/wrapper/glew_texture_objects_nomain.o: ${OBJECTDIR}/gloop/wrapper/glew_texture_objects.o gloop/wrapper/glew_texture_objects.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sdl2` `pkg-config --cflags glew` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/wrapper/glew_texture_objects_nomain.o gloop/wrapper/glew_texture_objects.cpp;\
	else  \
