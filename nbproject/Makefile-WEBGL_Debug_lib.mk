...
${OBJECTDIR}/cglgfx/graphics.o: cglgfx/graphics.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -O `pkg-config --cflags glesv2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cglgfx/graphics.o cglgfx/graphics.cpp
...
${OBJECTDIR}/glgfx/skyline_packer.o: glgfx/skyline_packer.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx
	${RM} "$@.d"
	$(COMPILE.cc) -g -O `pkg-config --cflags glesv2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/skyline_packer.o glgfx/skyline_packer.cpp
...
${OBJECTDIR}/glgfx/sprite_sheet.o: glgfx/sprite_sheet.cpp
	${MKDIR} -p ${OBJECTDIR}/glgfx
	${RM} "$@.d"
	$(COMPILE.cc) -g -O `pkg-config --cflags glesv2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/glgfx/sprite_sheet.o glgfx/sprite_sheet.cpp
...
${OBJECTDIR}/gloop/matrices.o: gloop/matrices.cpp
	${MKDIR} -p ${OBJECTDIR}/gloop
	${RM} "$@.d"
	$(COMPILE.cc) -g -O `pkg-config --cflags glesv2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gloop/matrices.o gloop/matrices.cpp
...
${OBJECTDIR}/sprite_test.o: sprite_test.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -O `pkg-config --cflags glesv2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sprite_test.o sprite_test.cpp
